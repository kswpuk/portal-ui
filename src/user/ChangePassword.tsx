...
export default function ChangePassword() {
  ...
  const changePassword: SubmitHandler<ChangePasswordInputs> = data => {
    setSuccess(false)
    setLoading(true)
    setError(null)
  ...
  return <>
    <form onSubmit={handleSubmit(changePassword)}>
      <Stack spacing={3}>
        ...
        <Typography>For security, please enter your current password so we can confirm it's you!</Typography>
