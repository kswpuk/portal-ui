...
interface HomeMembershipDetailsProps {
  member: Member
}

export default function HomeMembershipDetails(props: HomeMembershipDetailsProps) {
  ...
  return <Card>
    <CardHeader title={name} subheader={committeeRoles[props.member.role as CommitteeRole]?.name || "Member"} />
    <CardMedia component={() => 
