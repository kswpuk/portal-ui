...
interface SidebarProps {
  /**
   * Username of the current user (i.e. their membership number)
   */
  username: string

  /**
   * Controls whether the drawer is open (true) or not (false)
   */
  isOpen: boolean

  /**
   * Function that should be called when the user requests to close the drawer
   */ 
  onDrawerClose: () => void

  /**
   * Function that should be called when the user requests to sign out
   */
  signOut: () => void
}

export default function Sidebar(props: SidebarProps) {
  const selected = useAppSelector((state) => state.nav.selected)
