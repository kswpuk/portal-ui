...
export default function Submitted(props){
  return <>
    ...
    <Typography variant="body1" gutterBottom>
      We will be in touch once we have approved your application, or if we have any further queries regarding it. If you have any questions, you can contact our Membership Coordinator at <Link href="mailto:members@qswp.org.uk">members@qswp.org.uk</Link>.
    </Typography>
  </>
}