...
export default function Submitted(props){
  return <>
    ...
    <Typography variant="body1" gutterBottom>
      Thank you for your application to join the King's Scout Working Party.
    ...
    <Typography variant="body1" gutterBottom>
      ...
      If you have any questions, you can contact our Membership Coordinator at <Link href="mailto:members@kswp.org.uk">members@kswp.org.uk</Link>.
