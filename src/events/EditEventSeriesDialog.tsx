...
export default function EditEventSeriesDialog(props: EditEventSeriesDialogProps) {
  const { register, handleSubmit, reset, control, formState: { errors } } = useForm<EventSeries>({mode: 'onTouched'});
