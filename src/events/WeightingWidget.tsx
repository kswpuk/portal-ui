interface WeightingWidgetProps {
  criteria: { [rule: string]: number}
}

export default function WeightingWidget(props: WeightingWidgetProps){
  return <ul>
...
function getRuleText(rule: string) {
  switch(rule){
    // Age
    case "under_25":
      return "are under 25"
...
function getWeightingText(rule: string, weighting: number) {
