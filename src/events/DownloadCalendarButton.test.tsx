...
describe("DownloadCalendarButton", () => {
  ...
  it("generates correct .ics content with built event URL and series description", async () => {
    ...
    expect(blobText).toContain("SUMMARY:Social Gathering (KSWP Event)")
    ...
    expect(blobText).toContain("URL:https://portal.kswp.org.uk/events/socials-1/instance-99")
  ...
  it("handles description fallback when event series description is missing", async () => {
    ...
    expect(blobText).toContain("URL:https://portal.kswp.org.uk/events/series-abc/event-xyz")
  })
})
