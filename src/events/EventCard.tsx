...
interface EventCardProps {
  ...
  /**
   * If true, then allocation information will be hidden
   */
  hideAllocation?: boolean

  /**
   * If true, then deadline information will be hidden
   */
  hideDeadline?: boolean

  /**
   * Optional title to display on the card
   */
  title?: string
  
  /**
   * If true, then the card will be displayed with "flat" styling, otherwise it will be displayed elevated
   */
  flat?: boolean
}
