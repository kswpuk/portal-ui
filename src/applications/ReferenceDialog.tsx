...
interface ReferenceDialogProps {
  ...
  /**
   * Function to call when the user requests closing the dialog
   */
  onClose: () => void
...
export default function ReferenceDialog(props: ReferenceDialogProps) {
            ...
            <Table size="small">
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>{new Date((data.submittedAt || 0)*1000).toLocaleString()}</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </Box>
